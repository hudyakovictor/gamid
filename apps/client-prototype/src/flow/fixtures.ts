import type { ScenarioPackage } from "@signal-arena/contracts/src";

/**
 * Local copy of the foundation ScenarioPackage fixture used by client flow
 * tests. The server-side canonical fixture lives in
 * `packages/content/src/fixtures/starter-scenario.ts`; this copy keeps the
 * client tests independent from the content package at test time.
 */
export const starterScenarioFixture: ScenarioPackage = {
