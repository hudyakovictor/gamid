import { Loader, Utils, Scene, Events, Scenes, Plugins } from 'phaser';
...
var StartLoadingAnimationScene = function (
    ...
    if (mainScene.scene.getStatus(animationSceneKey) < Scenes.START) { // Phaser.Scenes.START = 2
...
class LoadingAnimationScenePlugin extends Plugins.BasePlugin {
...
export { LoadingAnimationScenePlugin as default };
