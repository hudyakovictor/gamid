import { Scale, Geom, Plugins } from 'phaser';

var WarnCounter = 0;

var CheckScaleMode = function (scene) {
    var scaleManager = scene.sys.scale;
    if (scaleManager.scaleMode === Scale.RESIZE) {
        return true;
    }
...
const CopyRectangle = Geom.Rectangle.CopyFrom;
...
class ScaleOuterPlugin extends Plugins.ScenePlugin {
...
export { ScaleOuterPlugin as default };
